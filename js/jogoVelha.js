...
// elementos que têm a classe 'board'".
...
function verificaVitoria() {
    ...
    for (const combinacao of combinacoesVitoria) {
        // Desestrutura a combinação atual em três variáveis: a, b e c (índices das células).
...
function tratarCliqueCelula(evento) {
    ...
    if (verificaVitoria()) {
        // Se venceu, exibe a mensagem de vitória e define 'jogoAcabou' como verdadeiro.
...
// Quando o botão for clicado, a função 'reiniciarJogo' será chamada.
